...
public final class Field {
    ...
    public static void drawSnake(Snake snake) {
        ...
        for (Position p : snake.getSnakePosition()) {
            if (!p.equals(head)) {
                screen.putString(p.getX(), p.getY(), SNAKE_BODY_STRING, snakeColor, null);
            } else {
                screen.putString(p.getX(), p.getY(), SNAKE_HEAD_STRING, snakeColor, null);
            }
        }
        screen.refresh();
    }
    ...
    public static void clearTail(Snake snake) {
        ...
        screen.putString(tail.getX(), tail.getY(), " ", null, null);
    }
    ...
    public static void drawFruit(Fruit fruit) {
        System.out.println(fruit.getPosition().getX());
        System.out.println(fruit.getPosition().getY());
        screen.putString(fruit.getPosition().getX(), fruit.getPosition().getY(), FRUIT_STRING, Terminal.Color.MAGENTA, null);
    }
